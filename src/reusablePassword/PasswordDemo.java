...
class demoFrame extends JFrame implements ActionListener
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2668972416916793255L;
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			JOptionPane.showMessageDialog(this, "No Password yet created", "Invalid password. Try again.", JOptionPane.ERROR_MESSAGE);
		}
		catch (Exception ex)
		{
